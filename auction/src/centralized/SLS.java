...
public class SLS {
	...
	public static SLSSolution Solve(List<Vehicle> vehicles, List<Task> tasks, long timeout) {
		...
		while (System.currentTimeMillis() - timeoutStart < timeout - TIMEOUT_MARGIN) {
	...
	private static SLSSolution selectInitialSolution(List<Vehicle> vehicles, List<Task> tasks) {
